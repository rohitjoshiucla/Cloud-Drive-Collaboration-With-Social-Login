		...
		<div class="container-fluid">
			<div class="row-fluid">		
				<div class="span9 offset3">
					...
					if(session.getAttribute(BXbean.NAME_PATH_LIST)!=null){
						...
						<%hmap=(HashMap<String,Object>)pathList.get(i);%>
							<a href="${pageContext.request.contextPath}/DB1servlet?<%=BXbean.NAME_PATH%>=<%=hmap.get("folder-id")%>">
								<%=hmap.get("name")%>
							</a>
					        	...
					        	%>
						        	<tr>
						        		<td>
								        	...
								        	%>	
       										<a href="${pageContext.request.contextPath}/DB1servlet?<%=BXbean.NAME_PATH%>=<%=objInner.getString("folder-id")%>"><%=objInner.getString("name")%></a>
   										</td>
						        		<td>
